...
import { updatePairDayData, updateTokenDayData, updateKaleidoswapDayData, updatePairHourData } from './dayUpdates'
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = KaleidoswapFactory.load(FACTORY_ADDRESS)
...
export function handleMint(event: Mint): void {
  ...
  updateKaleidoswapDayData(event)
...
export function handleSwap(event: Swap): void {
  ...
  let uniswapDayData = updateKaleidoswapDayData(event)
